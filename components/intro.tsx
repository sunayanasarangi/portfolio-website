...
export default function Intro() {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="mb-28 max-w-[50rem] text-center sm:mb scroll-mt-[100rem]"
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="https://drive.google.com/uc?export=view&id=1ZQyErHVds_JQtDgkiiz8-S1x7QprItP6"
              alt="Sunayana portrait"
              width="192"
              height="192"
              quality="95"
              priority={true}
      ...
      >
        <span className="font-bold">Hello, I'm Sunayana.</span> I'm a{" "}
        <span className="font-bold">full-stack developer</span> with{" "}
        <span className="font-bold">5+ years</span> of experience specializing
        in <span className="font-bold">backend development and API</span>. I
      ...
      >
        ...
        <a
          ...
          href="/Lebenslauf_SunayanaSarangi.pdf"
          download
        >
          Download CV{" "}
        ...
        <a
          ...
          href="https://www.linkedin.com/in/sunayana-sarangi-baa8a032/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/sunayanasarangi"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
